...
def get_and_clear(request):
	return FlashWrapper(request).get_and_clear()

def append(request, message):
    FlashWrapper(request).append(message)

def error(request,message):
    FlashWrapper(request).error(message)

def append_error(request, message):
    FlashWrapper(request).append_error(message)

def set(request, message):
    FlashWrapper(request).set(message)
